...
// Password reset
userRoutes.post("/forget-password-token", 
expressAsyncHandler(async (req, res) => {
...
userRoutes.put("/password", authMiddleware, 
expressAsyncHandler(async (req, res) => {
...
userRoutes.put("/follow", authMiddleware, 
expressAsyncHandler(async (req, res) => {
...
userRoutes.put("/verify-account", authMiddleware, 
expressAsyncHandler(async (req, res) => {
...
userRoutes.put("/unfollow", authMiddleware,
expressAsyncHandler(async (req, res) => {
...
userRoutes.put("/block-user/:id", authMiddleware, 
expressAsyncHandler(async (req, res) => {
  const { id } = req.params;
...
userRoutes.put("/unblock-user/:id", authMiddleware, 
expressAsyncHandler(async (req, res) => {
  const { id } = req.params;
  validateMongodbId(id);
...
userRoutes.get("/profile/:id", authMiddleware, expressAsyncHandler(async (req, res) => {
  const { id } = req.params;
  validateMongodbId(id);
...
userRoutes.put("/", authMiddleware, expressAsyncHandler(async (req, res) => {
  const { _id } = req?.user;
  //block
  blockUser(req?.user);
  validateMongodbId(_id);
