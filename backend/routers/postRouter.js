...
import { authMiddleware,validateMongodbId,cloudinaryUploadImg,blockUser } from '../utils.js';
...
postRouter.put("/likes", authMiddleware,
expressAsyncHandler(async (req, res) => {
...
postRouter.put("/dislikes", authMiddleware,
expressAsyncHandler(async (req, res) => {
